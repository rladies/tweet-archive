...
def url(item):
    return "https://twitter.com/RLadiesGlobal/status/" + item["id_str"]
...
<head>
  ...
  <title>R-Ladies Global's twitter archive</title>
...
<body>
  <div class="wrapper" id="app">
    <h1><a href="../../..">R-Ladies Global's twitter archive</a></h1>
          ...
          <div><div class="tweet-header">
              ...
              <div class="tweet-name-row">
                <div class="fullname-and-username">
                  <a class="fullname" href="/" title="R-Ladies Global">R-Ladies Global</a>
                  <a class="username" href="/" title="@RLadiesGlobal">@RLadiesGlobal</a>
                </div>
...
def main():
    data = read_data()
    for item in data:
        os.makedirs(f"RLadiesGlobal/status/{item['id_str']}", exist_ok=True)
        with open(f"./RLadiesGlobal/status/{item['id_str']}/index.html", "w") as f:
